# PAQUETES Los paquetes son las carpetas que contienen varios módulos y cada uno con una función distinta.

# Para ello debe tener siempre un archivo de nombre __init__.py (por lo general esta vacio,
#  ya que así es compatible con programas python versiones anteriores a la 3), con esto le estamos indicado a python que esto se trata de un paquete y no de una carpeta.

# Para acceder a los módulos de los paquetes podemos utilizar estas opciones
# : import nombrecarpeta.nombremodulo from nombrecarpeta import nombremodulo from nombrecarpeta.nombremodulo import def
...
# __init__.py Se utiliza cuando debemos utilizar paquetes en versiones anteriores a python 3
#  o puede contener información la cual se ejecutara siempre, para este caso le colocamos el
#   titulo Bienvenido a la clase de Aritmetica.

# aritmetica.py va a contener nuestras operaciones aritmeticas que son, suma, resta, multiplicacion
#  y division:
